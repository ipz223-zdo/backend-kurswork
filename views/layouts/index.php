            ...
            <div class="dropdown text-end">
                ...
                <ul class="dropdown-menu text-small" aria-labelledby="dropdownMenuButton">
                    <?php if(\core\Core::isUserAdmin()) : ?>
                        ...
                        <li><a class="dropdown-item" href="/order/index">Оформлені замовлення</a></li>
                    <?php endif;?>
                    <li><a class="dropdown-item" href="/order/user/<?= Core::get()->session->get('user')['id'] ?>">Ваші замовлення</a></li>
                    <li><a class="dropdown-item" href="/users/update/<?= Core::get()->session->get('user')['id'] ?>">Змінити ваші дані</a></li>
                    <li>
